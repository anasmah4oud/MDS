...
export default function VideoView() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden font-sans" dir="rtl">
      {/* Header */}
      <header className="video-header h-16 md:h-20">
      ...
      <main className="flex flex-col lg:flex-row h-auto lg:h-[calc(100vh-5rem)] animate-fade-in-up">
        {/* Player Container */}
        ...
        {/* Lesson Info Sidebar */}
        <div className="video-sidebar w-full lg:w-[420px] bg-white border-r border-slate-100 p-6 md:p-10 flex flex-col overflow-y-auto">
