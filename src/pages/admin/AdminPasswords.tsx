  ...
  const handleReset = async () => {
    ...
    try {
      ...
      if (data && data.success) {
        const studentName = foundUser.first_name || 'الطالب';

        alert(
          `✅ تم تغيير كلمة مرور المستخدِم (${studentName}) بنجاح وبشكل فوري!`
        );
  ...
  return (
    <div className="min-h-screen bg-slate-50" dir="rtl">
      ...
      <main className="max-w-4xl mx-auto p-4 md:p-12">
          ...
          {foundUser && (
            ...
            >
              ...
              <div className="space-y-3">
                <label className="text-sm font-black text-slate-700 underline decoration-red-600">
                  كلمة المرور الجديدة
                </label>
              ...
              <div className="flex items-start gap-4 p-4 bg-amber-50 rounded-2xl border border-amber-100 text-amber-800 text-sm font-bold leading-relaxed">
                ...
                <p>
                  تنبيه: التغيير يتم فورياً في نظام الحماية التابع لـ Supabase،
                  تأكد من تزويد الطالب بكلمة المرور الجديدة فور حفظها ليتمكن من
                  تسجيل الدخول.
                </p>
              </div>
        ...
        <p className="mt-12 text-center text-slate-400 font-bold italic text-sm">
          منصة البارع محمود الديب - نظام الإدارة المركزي v1.0
        </p>
      </main>
    </div>
  );
